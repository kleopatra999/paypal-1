...
// Store the PNREF for delayed Capture
// This value gets sent over to the fulfillment team for processing
$pnref = $result_array['PNREF'];

echo "<a href='delaycap.php?pnref=" . $pnref . "'>Capture Funds</a>";
